...
function DataSciencePage() {
  const programData = {
    ...
    description:
      "Transform raw data into actionable insights. Master data analysis, visualization, statistical modeling, and dashboard creation to drive data-driven decision making.",
    ...
    curriculum: [
      ...
      },
      {
        ...
        description:
          "Perform comprehensive data analysis on real business data",
        duration: "1 week",
        phase: "foundation",
        topics: [
      ...
      },
      {
        ...
        description:
          "Create enterprise-level BI solution with real-time analytics",
        duration: "1 week",
        phase: "advanced",
        topics: [
      ...
      },
      {
        ...
        description:
          "Complete end-to-end data analysis and BI solution for business",
        duration: "1 week",
        phase: "advanced",
        topics: [
    ...
    projects: [
      {
        ...
        description:
          "Build comprehensive BI dashboard for revenue and operations analysis with real-time data visualization",
      ...
      },
      {
        ...
        description:
          "Develop customer segmentation and churn prediction system with interactive visualizations",
      ...
      },
      {
        ...
        description:
          "Create predictive model for sales forecasting using time series analysis and statistical methods",
      ...
      },
      {
        ...
        description:
          "Build comprehensive market analysis system with data visualization and competitor insights",
    ...
    reviews: [
      {
        ...
        company: "Microsoft",
        image:
          "https://ui-avatars.com/api/?name=Rahul+Verma&background=0A2342&color=fff&size=200",
        rating: 5,
      ...
      },
      {
        ...
        company: "Amazon",
        image:
          "https://ui-avatars.com/api/?name=Sanya+Malhotra&background=FF7A00&color=fff&size=200",
        rating: 5,
      ...
      },
      {
        ...
        company: "Flipkart",
        image:
          "https://ui-avatars.com/api/?name=Karan+Singh&background=0A2342&color=fff&size=200",
        rating: 5,
      ...
      },
      {
        ...
        company: "Adobe",
        image:
          "https://ui-avatars.com/api/?name=Divya+Nair&background=FF7A00&color=fff&size=200",
        rating: 5,
    ...
    instructors: [
      {
        ...
        image:
          "https://ui-avatars.com/api/?name=Priya+Sharma&background=0A2342&color=fff&size=200&bold=true",
      ...
      },
      {
        ...
        image:
          "https://ui-avatars.com/api/?name=Amit+Patel&background=FF7A00&color=fff&size=200&bold=true",
      ...
      },
      {
        ...
        image:
          "https://ui-avatars.com/api/?name=Neha+Kapoor&background=0A2342&color=fff&size=200&bold=true",
    ...
    prerequisites: {
      ...
      idealFor: [
        ...
        "Recent graduates in any field",
        "Professionals seeking career transition into data",
        "Marketing professionals wanting data skills",
      ],
    },
    batchInfo: {
    ...
    faqs: [
      {
        ...
        answer:
          "No! Our Foundation plan starts with Python basics. We recommend basic computer skills and logical thinking.",
      },
      {
        question: "What tools will I learn?",
        answer:
          "You'll master Python, SQL, Tableau, Power BI, Excel, and various data science libraries like Pandas, NumPy, and Scikit-learn.",
      },
      {
        question: "Can I work while learning?",
        answer:
          "Absolutely! Our flexible schedule includes weekend and evening batches designed for working professionals.",
      },
      {
        question: "Is there placement support?",
        answer:
          "Yes! The Premium plan includes 100% placement assistance with resume building, mock interviews, and job referrals to 100+ partner companies.",
      },
      {
        question: "What is the batch size?",
        answer:
          "We maintain small batches of 25-30 students for personalized attention and better interaction with instructors.",
      },
      {
        question: "Will I get certifications?",
        answer:
          "Yes! You'll receive Venura certification plus guidance for industry certifications from Microsoft, Google, and Tableau.",
      },
      {
        question: "What if I miss classes?",
        answer:
          "All sessions are recorded and available lifetime. You can watch them anytime and ask questions in our active community.",
      },
      {
        question: "How much time do I need weekly?",
        answer:
          "We recommend 8-12 hours per week including live sessions, practice, and projects for optimal learning outcomes.",
      },
    ],
    learningFormat: {
      mode: "Live + Recorded",
      ...
      communityAccess:
        "Lifetime access to Venura Data Science community with 950+ members",
